            ...
            <CardContent className="p-0">
              <div className="aspect-video bg-muted rounded-lg flex items-center justify-center">
                <div className="text-center space-y-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold">SLIIT Malabe Campus</h3>
                    <p className="text-muted-foreground">New Kandy Road, Malabe, Sri Lanka</p>
                  </div>
            ...
            {[
              {
                ...
                answer:
                  "You can join by filling out our membership form on the website or attending one of our events. Membership is open to all SLIIT Computer Science students.",
              },
              {
                question: "Are events free for members?",
                answer:
                  "Most of our events are free for members. Some specialized workshops or bootcamps may have a nominal fee to cover materials and refreshments.",
              },
              {
                question: "Can I propose an event or workshop?",
                answer:
                  "We encourage members to propose events, workshops, or talks. Contact us with your idea and we'll help you organize it.",
              },
              {
                question: "How often do you organize events?",
                answer:
                  "We typically organize 2-3 events per month, including workshops, seminars, competitions, and networking sessions.",
              },
            ].map((faq, index) => (
              <Card key={index}>
                <CardHeader>
